...
const Home = () => {
  ...
  return (<>
    <div
      className="home-container" style={{ backgroundImage: `url(${bgImage})`}}
    >
      <h1 className="home-title" data-aos="fade-up">
        Welcome to Employee Management System
      </h1>

      <p className="lead text-light text-center" data-aos="fade-up" data-aos-delay="200">
        Manage all your company employees efficiently using this simple and
        smart application 
      </p>

      <div className="mt-5 text-center" data-aos="fade-up" data-aos-delay="400">
...
<div className="employee-slider mt-5" data-aos="zoom-in" data-aos-delay="600">
